...
<body>
	...
	<?php
		foreach ($webserv as $w) {
		$parameter = explode(";", $w->parameter);
		$name = array();
	...
	<div id="container">
		<ul>
			<li>Type : <?php if ($w->type == 0) echo 'GET'; else echo 'POST'; ?>
			<li>Nom : <?php echo $w->name; ?></li>
			<li>Short desc : <?php echo $w->desc_short; ?></li>
			<li>Desc : <?php echo $w->desc; ?></li>
			<li>Path : <?php echo $w->path.$w->name; ?></li>
			<li>Arg : <?php echo $w->name.'/';
			foreach ($name as $n) {
				echo '{'.$n.'}';
				echo '/';
			}?>
			<li>Retour : <pre><code class="language-php"><?php echo nl2br($w->return_success); ?></code></pre></li>
			<li>Error : <pre><code class="language-php"><?php echo nl2br($w->return_error); ?></code></pre></li>
		</ul>
